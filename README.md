...
*	**byte_two** (entrada): O segundo byte de dado a ser transmitido.
...
<p align="justify"> 
Para realizar a sequencia dos dados que serão enviados foi usado MEF com 5 estados:
